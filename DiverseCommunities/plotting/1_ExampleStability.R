########################################################
# Examples of stable and unstable dynamics to create
# panel (C) of Figure 1
########################################################
...
# builds a list of parameters and sets the target abundances
...
# setting the initial conditions to be at equilibrium
